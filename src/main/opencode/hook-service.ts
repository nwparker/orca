...
export function getOpenCodeFamilyPluginSource(hookPathname: string): string {
  ...
  return [
    ...
    '    if (rootSessionID) await publishAggregateStatus(factoryID, rootSessionID);',
    '    return;',
    '  }',
    ...
    '    if (event.type === "session.idle" || statusType === "idle") {',
    '      const attentionRootSessionID = clearAttentionForSession(sessionID, factoryID);',
    '      if (attentionRootSessionID) {',
    '        await publishAggregateStatus(factoryID, attentionRootSessionID);',
    '      }',
    '    }',
    '    return;',
    '  }',
    ...
    '      const attentionRootSessionID = clearAttentionForSession(sessionID, factoryID);',
    '      if (attentionRootSessionID && latestBusyRoot()) {',
    '        await publishAggregateStatus(factoryID, attentionRootSessionID);',
    '      }',
    '    }',
    '    return;',
